...
shinyServer(function(input, output) { 
  ...
  link_STEMITV=
    a("唐崇榮國際佈道團 STEMI", 
      href="https://www.stemi.org.tw",
      style = "color:blue;font-size:18px", target="_blank")
  
  link_STEMIYT=
    a("唐崇榮國際佈道團STEMI Taiwan (YouTube)", 
      href="https://www.youtube.com/@STEMITaiwan",
      style = "color:blue;font-size:18px", target="_blank")
  ...
  repent1 = 
    a("當代悔改真義──林慈信 博士 (第一集)", 
      href="https://www.youtube.com/watch?v=crwXHYVgE2w&t=0s",
      style = "color:blue;font-size:18px", target="_blank")
  
  repent2 = 
    a("當代悔改真義──林慈信 博士 (第二集)", 
      href="https://www.youtube.com/watch?v=TEQlV4eLd-Q",
      style = "color:blue;font-size:18px", target="_blank")
  
  output$repent1 = renderUI({
    
    tagList(repent1)
    
  })
  
  output$repent2 = renderUI({
  ...
  output$STEMIYT= renderUI({
    
    tagList(link_STEMIYT)
    
  })
  
  output$STEMITV= renderUI({
    
    tagList(link_STEMITV)
